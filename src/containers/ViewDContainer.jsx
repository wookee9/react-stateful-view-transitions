...
class ViewDContainer extends React.Component {
  componentWillMount() {
  ...
  render() {
    return (
      <ViewD {...this.props} animationClass={this.state.animation} />
    );
  }
}
...
function mapStateToProps({ router }) {
  ...
  return {
    timeToLeave: targetKey !== 'ViewD',
  };
}

ViewDContainer.propTypes = {
  dispatch: PropTypes.func.isRequired,
  timeToLeave: PropTypes.bool.isRequired,
  uniqueKey: PropTypes.string.isRequired,
};

export default connect(mapStateToProps, mapDispatchToProps)(ViewDContainer);
